...
test("page markdown serialization preserves intentionally empty view bodies", async () => {
    const markdown = await pageMarkdownFromWorkspace(
        {
            ...workspace,
            views: [
                {
                    ...
                    mode: "article",
                    content: "",
                    displays: [{ id: "display-1", name: "Display", kind: "data-card", data: {} }],
                },
            ],
        },
        "page-1",
