...
export const createView = (topicId: string, title: string, mode: ViewMode = "article"): NotebookView => ({
    ...
    content:
        mode === "article"
            ? ["# Article", "{{toc}}", "## Why this view exists", "Use this mode to write long-form documentation with embedded live displays.", "## Section title", "Start writing the next section."].join("\n\n")
            : mode === "dashboard"
